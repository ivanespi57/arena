...
class EventoResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'asientos_disponibles'=> $this->when($request->routeIs('eventos.show'), fn() => $this->totalAsientosDisponibles()),
            'entradas_vendidas'   => $this->when($request->routeIs('eventos.show'), fn() => $this->totalEntradasVendidas()),
        ];
    }
}
